    ...
    <div className={styles.th}>
      ...
      <div style={{display:"flex"}}>
          <div style={{marginRight:"20px"}}>
             { product.product &&  <img src={product.product.image} width="60px" alt='pich'/>}
          </div>
          <div>
              <div>
                 {product.product && <p>{product.product.name}</p>}
                 {product.product && <p>Colour: Default | Size: {product.product.size[1]}</p>}
              </div>
      ...
      {product.product && <div>Rs. {product.product.price}</div>}
      <div>
      ...
      {product.product && <div>Rs. {product.product.price * product.quntity}</div>}
